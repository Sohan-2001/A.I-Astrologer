...
export default function Home() {
  ...
  if (!user) {
    return (
      <main className="relative h-full w-full flex items-center justify-center overflow-hidden">
        {landingPageBg && (
           <Image
        ...
        <div className="relative z-10 flex flex-col items-center text-center text-white p-4">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mb-8 animate-fade-in-up">
           ...
           <div className="flex flex-col items-center justify-center gap-6 mb-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <h2 className="text-2xl font-semibold">What you get:</h2>
            <ul className="flex flex-col md:flex-row gap-4 text-left">
              <li className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-green-400" /> In-depth Birth Chart Analysis</li>
              <li className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-green-400" /> Predictions for Major Life Events</li>
              <li className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-green-400" /> Interactive Chat with an AI Astrologer</li>
            </ul>
          </div>
          <Button
