    ...
    return (
      <div className="relative h-full w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center text-white p-4">
          ...
          <h1 className="text-5xl md:text-6xl font-bold font-headline mb-4 animate-fade-in-down">
            A.I. Astrologer
          </h1>
          ...
          <Button
            ...
            size="lg"
            className="animate-fade-in-up bg-red-600 hover:bg-red-700 text-white"
          >
